      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div class="mx-auto mb-[60px] max-w-[620px] text-center">
            ...
            <h2
              style="color: #786d64"
              class="mb-4 text-3xl font-bold sm:text-4xl md:text-[42px]"
            >
              Meet Our Team
            </h2>
          </div>
      ...
      <div class="-mx-4 flex flex-wrap justify-center">
        <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
          <div class="wow fadeInUp mb-10" data-wow-delay=".1s">
            ...
            <div style="color: #786d64" class="text-center">
              <h4 class="mb-2 text-lg font-medium">YU DOKYUNG</h4>
              <p class="mb-2 text-sm font-medium">Front End</p>
              <p class="mb-2 text-sm font-medium">Back End</p>
              <p class="mb-2 text-sm font-medium">Data Base</p>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
          <div class="wow fadeInUp mb-10" data-wow-delay=".15s">
            ...
            <div style="color: #786d64" class="text-center">
              <h4 class="mb-2 text-lg font-medium">LEE DAYEONG</h4>
              <p class="mb-2 text-sm font-medium">Front End</p>
              <p class="mb-2 text-sm font-medium">Back End</p>
              <p class="mb-2 text-sm font-medium">Data Base</p>
              <div class="flex items-center justify-center">
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
          <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
            ...
            <div style="color: #786d64" class="text-center">
              <h4 class="mb-2 text-lg font-medium">SON JIMIN</h4>
              <p class="mb-2 text-sm font-medium">Front End</p>
              <p class="mb-2 text-sm font-medium">Back End</p>
              <p class="mb-2 text-sm font-medium">Data Base</p>
              <div class="flex items-center justify-center">
